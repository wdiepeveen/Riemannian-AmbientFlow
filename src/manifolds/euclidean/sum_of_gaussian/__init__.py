...
class SumOfGaussianEuclidean(Euclidean): 
    ...
    # return torch.sum(torch.einsum("Nmab,Nnac->Nmnbc", softmax_psi_x[:,:,None,None] * self.inverse_matrices[None], softmax_psi_x[:,:,None,None] * self.inverse_matrices[None]), [1,2])
