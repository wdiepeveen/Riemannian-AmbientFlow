...
from src.manifolds.euclidean.vector.approx.diagonal_metric import DiagonalMetricApproxVectorEuclidean

class SumOfDiagonalGaussianApproxVectorEuclidean(DiagonalMetricApproxVectorEuclidean):
