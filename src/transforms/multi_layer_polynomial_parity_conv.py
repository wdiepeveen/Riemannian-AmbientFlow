...
class MultiLayerPolynomialParityConv2DTransform(Transform):
    def __init__(self, in_channels, height, width, kernel_size, latent_channels, order=2, parity=0):
        ...
        self.cnn = nn.Sequential(
            *[
                MaskedConv2d(self.C, self.L, self.K, padding=self.P, bias=False),
                PolynomialActivation(self.L, order=self.order),
