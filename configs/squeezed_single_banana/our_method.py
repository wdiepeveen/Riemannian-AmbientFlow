...
def get_config():
    ...
    config.experiment = "our_method_jacobian_iso_vol"
    ...
    config.checkpoint = '/home/gb511/riemannian_geo/results/squeezed_single_banana/affine/our_method_jacobian_iso_vol/checkpoints/checkpoint_epoch_610_loss_1.922.pth'
