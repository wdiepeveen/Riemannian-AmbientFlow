...
def get_config():
    ...
    config.checkpoint = '/home/gb511/riemannian_geo/results/squeezed_single_banana/affine/standard_normal_jacobian_iso/checkpoints/checkpoint_epoch_170_loss_3.213.pth'
